...
insert into tbFuncionarios(codFunc,nome,email,telefone,cpf,idade,salario) values(3,'Mario de Andrade','mario.adrade@yahoo.com','97852-5214','369.417.587-88',25,1600);
insert into tbFuncionarios(nome,email) values('Ronaldo Rodrigues','ronaldo.rodrigues@gmail.com');
insert into tbFuncionarios(codFunc,email,cpf) values(5,'fernando.ccunha','524.652.574-88');
insert into tbFuncionarios(codFunc,email,cpf) values(5,'fernando.ccunha','524.652.574-88');
insert into tbFuncionarios(codFunc,email,cpf) values(5,'fernando.ccunha','524.652.574-88');
insert into tbFuncionarios(codFunc,email,cpf) values(5,'fernando.ccunha','524.652.574-88');
